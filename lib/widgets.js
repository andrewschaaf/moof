(function() {
  ...
  Button = (function() {
    ...
    function Button() {
      ...
      Button.__super__.constructor.call(this, 'a', classes, [this.overlay = E('div', 'overlay')]);
      if (type === 'lmr') {
        this.appendChildren([E('table', [E('tr', [E('td', "LR L"), E('td', "M"), E('td', "LR R")])])]);
      }
      this.on('click', (__bind(function(e) {
        return this.click(e);
      }, this)));
      text = null;
      opt = {};
      ...
      if (text) {
        this.overlay.appendChild(this.label = D('label', [text]));
      }
    }
